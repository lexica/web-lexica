...
export type TranslationsKeys = {
  ...
  'pages.preferences.androidSettings': string,
  'pages.androidIntegration.title': string,
  'pages.androidIntegration.autoDetectAndroidPrompt': string,
  'pages.androidIntegration.autoDetectAndroidHint': string,
  'pages.androidIntegration.autoRedirectPrompt': string,
  'pages.androidIntegration.autoRedirectHint': string,
  'pages.androidIntegration.forceShowAndroidSettingsPrompt': string,
  'pages.androidIntegration.forceShowAndroidSettingsHint': string,
  'pages.androidIntegration.forceHideAndroidSettingsPrompt': string,
  'pages.androidIntegration.forceHideAndroidSettingsHint': string,
