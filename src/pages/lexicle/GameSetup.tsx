import { useCallback, useEffect, type ReactNode, useContext, useMemo, useState } from 'react'
import { ConfirmationEffect } from '../../components/game/Board/hooks'
import { Board, useGeneratedBoard } from '../../game/board/hooks'
import { Dictionary, type DictionaryState, useBoardDictionary } from '../../game/dictionary/hooks'
...
import { Score, type ScoreState, useScore, ValidAnswers } from '../../game/lexicle/score'
